...
cva_estimator_portfolio_int.train(features_gen=cva_portfolio_features_gen_int, labels_as_cuda_tensors=True, train_time = [1])
...
with open('./new_CVA0.01_oneshot_NN.pickle', 'wb') as f:
        data = {}
