...
class DiffusionEngine:
    def __init__(self, irs_batch_size, vanilla_batch_size, num_coarse_steps, dT, num_fine_per_coarse, dt, num_paths, num_inner_paths, 
                 ...
                 initial_values, initial_defaults, cDtoH_freq, device=0, no_nested_cva=False, no_nested_im=False, num_adam_iters=100, lam=1, gamma=0.5, adam_b1=0.9, adam_b2=0.999, startAtPar = True):
